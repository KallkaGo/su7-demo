...
const Sketch3 = () => {
    ...
    useGSAP(
        () => {
            ...
            const flooMat = modelRef.current.floor
                ...
                t1.to(
                    baseParam,
                    {
                        ...
                        onUpdate: () => {
                            ...
                            flooMat &&
                                (flooMat.envMapIntensity =
                                    baseParam.floorEnvIntensity);
                            wheel.forEach((item) => {
                                const mat =
                                    item.material as MeshStandardMaterial;
                                mat.roughness = baseParam.wheelRoughness;
                                mat.envMapIntensity =
                                    baseParam.wheelEnvIntensity;
                            });
                            bloomRef.current.intensity =
                                baseParam.bloomIntensity;
                            bloomRef.current.luminanceThreshold =
                                baseParam.bloomThreshold;
                        },
                    },
                    1
                );
    ...
    const handleModel = () => {
        ...
        modelRef.current.lightMat = lightMat;
    };
    ...
    useFrame((state, delta) => {
        ...
        floorUniforms.uTime.value +=
            delta * params.current.floorNormalSpeed * 20;
